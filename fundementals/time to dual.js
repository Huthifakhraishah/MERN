...
class Unit extends Card{
    ...
    attack (target){
        ...
        console.log(this.name + "attacked" + target.name + "then minus " + this.power + " damage")
    }
}
...
class Effect extends Card{
    ...
    actUpon (effecttarget){
        ...
        console.log(this.name + " is played" + this.reseffect + " resistance and " + this.poweffect + " power to " + effecttarget.name);
    }
}
